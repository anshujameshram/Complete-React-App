        ...
        <div className={headerStyles.user}>
          ...
          <div className={headerStyles.menuContainer}>
            <div className={headerStyles.menu}>
              <div className={headerStyles.menuItem}><NavLink to="/profile">My Profile</NavLink></div>
              <div className={headerStyles.menuItem}><NavLink to="/cart">Order history</NavLink></div>
              <div
